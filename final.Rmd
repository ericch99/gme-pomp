...
To compute the profile likelihoods for parameters we want to investigate means determining, for each value of parameter set, the best likelihood that the model can achieve. We will first bound the uncertainty by putting a box around the highest-likelihood estimates we have found so far.  
