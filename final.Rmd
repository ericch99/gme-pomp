...
COMMENTS:
should Recovered have a chance to move back to $S2$?
</div>
...
dmeas <- Csnippet("lik = dbinom(count,H,rho,give_log);")
...
cbind(day = 1:nrow(gme), gme) %>% 
  pomp(times="day",t0=0,
       ...
       dmeasure=dmeas,
       accumvars="H", 
       partrans=parameter_trans(log=c("Beta1", "Beta2"),logit=c("rho","eta")),
       statenames=c("S1","S2","I","R"),
       paramnames=c("Beta1", "Beta2", "mu_S1S2", "mu_IR","eta", "rho","N") ) -> SIRR
