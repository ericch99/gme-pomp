...
gme %>% 
  pomp(times="day",t0=0,
       rprocess=euler(sir_step,delta.t=1/2),
       rinit=sir_init,
       rmeasure=rgme,
       dmeasure=dgme,
       accumvars="H", 
...
SSIR %>%
  simulate(params=c(Beta1=0.03,Beta2=1.5,mu_S1S2=0.8,mu_IR=0.9,mu_RS1=0.03,
                    rho=0.8,eta=0.7,N=1500),
