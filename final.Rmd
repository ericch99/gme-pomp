...
params <- c(Beta1=1,Beta2=1,mu_S1S2=0.5,mu_IR=0.5,mu_RS1=0.02,rho=0.1,eta=0.8,N=10000)
...
runif_design( lower=c(Beta1=0.5,Beta2=0.5,mu_S1S2=0.5,mu_IR=0.2,mu_RS1=0.01,rho=0.05,eta=0.8,N=10000), 
              upper=c(Beta1=1.5,Beta2=1.5,mu_S1S2=0.5,mu_IR=0.7,mu_RS1=0.04,rho=0.3,eta=0.8,N=30000),
              nseq=300) -> guesses
