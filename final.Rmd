...
```{r}
params=c(Beta1=1,Beta2=1,mu_S1S2=0.5,mu_IR=0.5,mu_RS1=0.02,rho=0.8,eta=0.8,N=2000)
params=c(Beta1=0.03,Beta2=1.5,mu_S1S2=0.9,mu_IR=0.8,mu_RS1=0.03,rho=0.8,eta=0.7,N=1500)
SSIR %>% pfilter(Np=500, params=params) -> pf
...
stew(file="results/pf1.rda",{
  t1 <- system.time(
    pf1 <- foreach(i=1:20,.packages='pomp') %dopar% 
      pfilter(SSIR,Np=gme_Np,params=params)
) })
